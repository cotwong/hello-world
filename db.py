...
db_user = os.environ.get('localhost')
db_password = os.environ.get('qwe123')
db_name = os.environ.get('demo-db')
cloud_sql_connection_name = os.environ.get('cloudwerx-assessment:us-central1:demo')
...
def create_connection():
    try:
        ...
        #conn = pymysql.connect(user=db_user, password=db_password,
        #    unix_socket=db_socket_dir, db=db_name, cursorclass=pymysql.cursors.DictCursor)
